 ...
 */
package thn.research.textutility.model;
...
public class LDAUtility {
     ...
     *
     * Here, the test set have the same documents and vocabulary as data in
     * model. Test set is divided from training set so that word instances in
     * each document are randomly selected. Note: This method only computes
     * perplexity from 1 chain (in provided model).
     *
     * @param model
